...
contract OctaNFTFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Octa auction contract address;
    address public auction;

    /// @notice Octa marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new OctaNFT contract
    ...
    /// @notice Method for registering existing OctaNFT contract
    ...
    /// @notice Method for disabling existing OctaNFT contract
    /// @param  tokenContractAddress Address of NFT contract
