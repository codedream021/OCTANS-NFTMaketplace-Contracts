 ...
 */
contract OctaAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event OctaAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "OctaAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit OctaAuctionContractDeployed();
        ...
        nonReentrant
    {
        ...
        IOctaMarketplace marketplace = IOctaMarketplace(
